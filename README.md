...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/japan_tenders_search \
  -H 'Content-Type: application/json' \
  -d '{"query":"橋梁","category":"works","prefecture":"Tokyo","limit":3}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/japan_tenders_search`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
